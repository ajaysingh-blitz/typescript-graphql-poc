       ...
       let data
        ...
        try {
          this.productService.getPageDetailsById("EeF9iVr5jC").then(result => {
            ...
            pageView.args.values.entries.values = data;
            pageView.args.child.args.body =
             getPadding(12, 12, 12, 12,
                getListView("vertical", [getTextView("${value['content']['title']}"), getTextView("title")])
            )
